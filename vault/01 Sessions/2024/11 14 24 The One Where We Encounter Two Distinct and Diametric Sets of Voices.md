---
title: "11/14/24 The One Where We Encounter Two Distinct and Diametric Sets of Voices"
type: session
tags:
  - "session"
  - "year-2024"
aliases:
  - "11/14/24 The One Where We Encounter Two Distinct and Diametric Sets of Voices"
last_edited: 2025-10-24
wiki_rev: "2025-10-24T17:38:48Z"
contributors:
  - "Hoppsy"
---
...
We decide to leave the voices as they are in our current state.
   ...
   1. We journey once more
...southward potentially through a mountain pass and hopefully back down into the autumn area.
...
> [!note] Image: `Screenshot 2024-11-14 at 9.48.33 PM.png`
...
> [!note] Image: `Screenshot 2024-11-14 at 9.53.29 PM.png`
...
> [!note] Image: `Screenshot 2024-11-14 at 9.56.13 PM.png`

> [!note] Image: `Screenshot 2024-11-14 at 9.58.17 PM.png`
...
[[Song|What should we try to play next]]?
...
- Silas’s song that reminds him of rain, the women of his people walking down to the river. **This is the same song that the Raven harided girl hummed when Branwen asked if she knew any songs** <Hopps> This is probably not correct, given recent (October 2025) conversations about songs.: https://drive.google.com/file/d/1c5QohNsa6fLafdFnGjKkARPeMQJgqdcQ/view?usp=drive_link
...
Silas goes up to a stone and puts a hand on it. He’s very aware of the texture of the rock. It does not make a sound like the stones on the island. These don’t have the same grooves as the island. 
   ...
   1. Postgame Hopps taking notes
[[Geshwa#:~:text=And so the,will cause trouble.|From Geshwa:]]
...
[[Cricket#:~:text=and again you are lifted yet higher, and you see that the stars look down upon the earth, and each star is a figure with black wings and black cloak holding lanterns of various colors. and each peers down. and you fall back to sleep|Cricket's Dream]]:
