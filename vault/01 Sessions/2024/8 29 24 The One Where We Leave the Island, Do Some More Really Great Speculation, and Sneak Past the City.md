...
Our traditional roles:> Scout (Exploration) - Silas (+6)
>
...
> [!note] Image: `Partial journey up the Autumn River.png`

B rolls travel (7), we make it one more hex.
> [!note] Image: `A homestead off of the Autumn River in Nyth.png`
